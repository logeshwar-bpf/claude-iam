...
export function updateUserPlan({ userId, newPlan, seats, billingCycle, adminUser, notes = '' }) {
  if (!adminUser || typeof adminUser !== 'string') {
    throw new Error('Authenticated adminUser identity is required for audit logging');
  }
